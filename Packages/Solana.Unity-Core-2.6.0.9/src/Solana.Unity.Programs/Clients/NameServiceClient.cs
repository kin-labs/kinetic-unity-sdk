...
using Solana.Unity.Programs.Models.NameService;
...
namespace Solana.Unity.Programs.Clients
{
    /// <summary>
    ...
    public class NameServiceClient : BaseClient
    {
        ...
        {
            var res = await RpcClient.GetProgramAccountsAsync(ProgramIdKey, Unity.Rpc.Types.Commitment.Confirmed, null,
            ...
            while (addressesCopy.Count > 0)
            {
                ...
                var multipleAccs = await RpcClient.GetMultipleAccountsAsync(currentReq, Unity.Rpc.Types.Commitment.Confirmed);
