...
using Solana.Unity.Programs.Models.Stake;
...
namespace Solana.Unity.Programs
{
    ...
    public static class StakeProgram
    {
        ...
        public static TransactionInstruction Initialize(PublicKey stakePubkey, State.Authorized authorized, State.Lockup lockup)
        {
        ...
        /// <returns>The transaction instruction.</returns>
        public static TransactionInstruction Authorize(PublicKey stakePubkey, PublicKey authorizedPubkey, PublicKey newAuthorizedPubkey, State.StakeAuthorize stakeAuthorize, PublicKey custodianPubkey)
        {
            List<AccountMeta> keys = new()
            {
                AccountMeta.Writable(stakePubkey,false),
        ...
        /// <returns>The transaction instruction.</returns>
        public static TransactionInstruction SetLockup(PublicKey stakePubkey, State.Lockup lockup, PublicKey custodianPubkey)
        {
            List<AccountMeta> keys = new()
            {
                AccountMeta.Writable(stakePubkey, false),
        ...
        /// <returns>The transaction instruction.</returns>
        public static TransactionInstruction AuthorizeWithSeed(PublicKey stakePubkey, PublicKey authorityBase, string authoritySeed, PublicKey authorityOwner, PublicKey newAuthorizedPubkey, State.StakeAuthorize stakeAuthorize, PublicKey custodianPubkey)
        {
            List<AccountMeta> keys = new()
            {
                AccountMeta.Writable(stakePubkey, false),
        ...
        /// <param name="authorized">Carries pubkeys that must sign staker transactions and withdrawer transactions</param>
        /// <returns>The transaction instruction.</returns>
        public static TransactionInstruction InitializeChecked(PublicKey stakePubkey, State.Authorized authorized)
        {
            List<AccountMeta> keys = new()
            {
                AccountMeta.Writable(stakePubkey, false),
        ...
        /// <param name="custodianPubkey">Lockup authority pubkey if updated withdrawer before lockup expiration</param>
        /// <returns>The transaction instruction.</returns>
        public static TransactionInstruction AuthorizeChecked(PublicKey stakePubkey, PublicKey authorizedPubkey, PublicKey newAuthorizedPubkey, State.StakeAuthorize stakeAuthorize, PublicKey custodianPubkey)
        {
            List<AccountMeta> keys = new()
            {
                AccountMeta.Writable(stakePubkey, false),
        ...
        /// <param name="custodianPubkey">Custodian pubkey</param>
        /// <returns>The transaction instruction.</returns>
        public static TransactionInstruction AuthorizeCheckedWithSeed(PublicKey stakePubkey, PublicKey authorityBase, string authoritySeed, PublicKey authorityOwner, PublicKey newAuthorizedPubkey, State.StakeAuthorize stakeAuthorize, PublicKey custodianPubkey)
        {
            List<AccountMeta> keys = new()
            {
                AccountMeta.Writable(stakePubkey, false),
        ...
        /// <param name="custodianPubkey">Lockup authority or withdraw authority</param>
        /// <returns>The transaction instruction.</returns>
        public static TransactionInstruction SetLockupChecked(PublicKey stakePubkey, State.Lockup lockup, PublicKey custodianPubkey)
        {
            List<AccountMeta> keys = new()
            {
                AccountMeta.Writable(stakePubkey, false),
            ...
            State.Lockup lockupChecked = new State.Lockup
            {
