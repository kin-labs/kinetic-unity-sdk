...
namespace Solana.Unity.Programs
{
    ...
    internal static class StakeProgramData
    {
        ...
        /// Summary text here
        /// </summary>
        internal static byte[] EncodeInitializeData(State.Authorized authorized, State.Lockup lockup)
        {
        ...
        internal static byte[] EncodeAuthorizeData(PublicKey newAuthorizedPubkey, State.StakeAuthorize stakeAuthorize)
        {
        ...
        internal static byte[] EncodeSetLockupData(State.Lockup lockup)
        {
        ...
        internal static byte[] EncodeAuthorizeWithSeedData(string authoritySeed, PublicKey newAuthorizedPubKey, State.StakeAuthorize stakeAuthorize, PublicKey authorityOwner)
        {
        ...
        internal static byte[] EncodeAuthorizeCheckedData(State.StakeAuthorize stakeAuthorize)
        {
        ...
        internal static byte[] EncodeAuthorizeCheckedWithSeedData(string authoritySeed, PublicKey authorityOwner, State.StakeAuthorize stakeAuthorize)
        {
            byte[] encodedSeed = Serialization.EncodeBincodeString(authoritySeed);
        ...
        internal static byte[] EncodeSetLockupCheckedData(State.Lockup lockup)
        {
        ...
        internal static void DecodeAuthorizeData(DecodedInstruction decodedInstruction, ReadOnlySpan<byte> data, IList<PublicKey> keys, byte[] keyIndices)
        {
            ...
            decodedInstruction.Values.Add("Stake Authorize", Enum.Parse(typeof(State.StakeAuthorize), data.GetU8(36).ToString()));
        }
                                                  ...
                                                  byte[] keyIndices)
        {
            ...
            decodedInstruction.Values.Add("Stake Authorize", Enum.Parse(typeof(State.StakeAuthorize), data.GetU8(4).ToString()));
        }
