...
public class GameController : MonoBehaviour
{
    ...
    async void Awake()
    {
        Debug.Log("Start setting up SDK");
        ...
        Debug.Log("Finish setting up SDK");
    }
    ...
    public async void CreateNewAccount()
    {
        ...
        await KineticSdk.CreateAccount(Keypair, commitment: Kinetic.Sdk.Interfaces.Commitment.Finalized);
